...
export const useEcranTravailStore = defineStore('ecranTravail', {
  state: () => ({
    ...
    currentPageIndex: 0,
    projetId: null,
    projetInfos: null, // Ajouté pour les infos du projet
    error: null,
    isLoading: false,
  ...
  actions: {
    ...
    // Nouvelle action pour récupérer les infos du projet
    ...
    async fetchEpisodes(projetId) {
      ...
      try {
        ...
        // Charger d'abord les infos du projet
  ...
  getters: {
    ...
    // Getter pour calculer le total des séquences
